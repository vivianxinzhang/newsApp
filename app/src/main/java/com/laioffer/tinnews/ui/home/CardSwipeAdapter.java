...
public class CardSwipeAdapter extends RecyclerView.Adapter<CardSwipeAdapter.CardSwipeViewHolder> {
    ...
    public void setArticles(List<Article> newsList) {
        ...
        // every time a new list is set, we call notifyDataSetChanged
        // to let the adapter refresh and re-render the data.
        notifyDataSetChanged();     // 这个哪里来的
    }
    ...
    public void onBindViewHolder(@NonNull CardSwipeViewHolder holder, int position) {
        ...
        // Picasso.get().load(article.urlToImage).resize(100, 100).into(holder.imageView);
